...
<div class="card">
    ...
    <div class="form-group mr-2">
        <input type="text" name="filters[name_ar]" value="{{ request('filters.name_ar') }}"
               class="form-control" placeholder="Search by Arabic Name">
    </div>

    <div class="form-group mr-2">
        <input type="text" name="filters[name_en]" value="{{ request('filters.name_en') }}"
               class="form-control" placeholder="Search by English Name">
    </div>

    <button type="submit" class="btn btn-primary">Filter</button>
    <a href="{{ route('dashboard.products.index') }}" class="btn btn-secondary ml-2">Reset</a>
</form>
