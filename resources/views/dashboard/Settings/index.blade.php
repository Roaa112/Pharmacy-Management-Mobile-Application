                ...
                <tbody>
                    @forelse($settings as $setting)
                        <tr>
                            ...
                            <td>{{ $setting->get_y }}</td>
                            <td>{{ $setting->points_validity_days }}</td>
                            <td>
                                <button class="btn btn-sm btn-info edit-Setting-btn" data-toggle="modal"
                                    data-target="#editSettingModal" data-id="{{ $setting->id }}"
                                    ...
                                    data-facebook="{{ $setting->facebook }}" data-instagram="{{ $setting->instagram }}"
                                    data-tiktok="{{ $setting->tiktok }}" data-youtube="{{ $setting->youtube }}"
